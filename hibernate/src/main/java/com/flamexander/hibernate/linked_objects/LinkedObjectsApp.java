package com.flamexander.hibernate.linked_objects;

import com.flamexander.hibernate.PrepareDataApp;
import com.flamexander.hibernate.one_to_many_and_back.Student;
import com.flamexander.hibernate.one_to_many_and_back.University;
...
public class LinkedObjectsApp {
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            BottomlessBox box2 = session.get(BottomlessBox.class, 2L);
            box.getThings().get(0).setBox(box2);
